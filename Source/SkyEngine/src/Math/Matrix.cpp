...
Matrix4x4 Matrix4x4::inverted()
{
	...
	if (tmpMat.m[3] == 0 && tmpMat.m[7] == 0 && tmpMat.m[11] == 0 && tmpMat.m[15] == 1)
		tmpMat.invertAffine();
	else
	{
		tmpMat.invertGeneral();
		/*@@ invertProjective() is not optimized (slower than generic one)
		if(fabs(m[0]*m[5] - m[1]*m[4]) > EPSILON)
		this->invertProjective();   // inverse using matrix partition
		else
...
///////////////////////////////////////////////////////////////////////////////
Matrix4x4& Matrix4x4::invertEuclidean()
{
...
///////////////////////////////////////////////////////////////////////////////
Matrix4x4& Matrix4x4::invertProjective()
{
	// partition
...
// M^-1 = adj(M) / det(M)
///////////////////////////////////////////////////////////////////////////////
Matrix4x4& Matrix4x4::invertGeneral()
{
