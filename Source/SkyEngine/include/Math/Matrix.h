...
public:
	...
	Matrix4x4&    invert();                               // check best inverse method before inverse

	Matrix4x4	inverted();
	Matrix4x4&    invertEuclidean();                      // inverse of Euclidean transform matrix
	Matrix4x4&    invertAffine();                         // inverse of affine transform matrix
	Matrix4x4&    invertProjective();                     // inverse of projective matrix using partitioning
	Matrix4x4&    invertGeneral();                        // inverse of generic matrix

														// transform matrix
	Matrix4x4&    translate(float x, float y, float z);   // translation by (x,y,z)
	Matrix4x4&    translate(const Vector3& v);            //
	Matrix4x4&    rotate(float angle, const Vector3& axis); // rotate angle(degree) along the given axix
...
inline void Matrix4x4::setRow(int index, const Vector4& v)
{
...
inline void Matrix4x4::setRow(int index, const Vector3& v)
{
...
inline void Matrix4x4::setColumn(int index, const Vector4& v)
{
...
inline void Matrix4x4::setColumn(int index, const Vector3& v)
{
